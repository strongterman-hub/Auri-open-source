...
当前开源版本基于 Android **0.3.29 / versionCode 32** 及 2026-09-11 的配套服务端。此版修复退出令牌撤销、隐私勾选持久化、断网消息状态，补齐应用和官网隐私政策，并同步 DeepSeek V4.1 Flash 的分时计费规则。官方服务、源码和第三方自部署实例是不同的运行环境；开源不包含官方服务的用户数据、访问权限、签名或供应商凭据。
